...
{    
    ...
    /// Bll2sys_role业务逻辑
    /// </summary>
    public partial class Bll2sys_role   
    {    
	    /// <summary>
        /// 修改
        /// </summary>
		...
		public static PageDataView<sys_role> GetPageData(string conwhere,string sortpara,int currentpage,int pagesize=15)
        {
        ...
        {
            var tt =  DalFactory.Createsys_role().GetWhere(wherela);
			return tt;
        }
        /// <summary>
        /// 按条件获得数量
