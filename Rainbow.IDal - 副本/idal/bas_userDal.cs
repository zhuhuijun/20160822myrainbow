...
{    
    ...
    /// bas_userDal实现
    /// </summary>
    public partial interface Ibas_user    
    {    
	    /// <summary>
        /// 更新数据实体到上下文
        /// </summary>
        ...
        /// <returns></returns>
        bool Insert(bas_user entity);
        /// <summary>
        /// 获得所有数据
        /// </summary>
        /// <returns></returns>
        IEnumerable<bas_user> GetAll();
        /// <summary>
        /// 根据主键获得数据
        /// </summary>
        ...
        /// <returns></returns>
        PageDataView<bas_user> GetPageData(PageCriteria criteria, object param = null);
        ///// <summary>
        ///// 匿名条件查询
        ///// </summary>
