...
$.jgrid.regional["cn"] = {
    defaults: {
        recordtext: "View {0} - {1} of {2}",//window.gridlocalelang.recordtext,  // 共字前是全角空格    {0} - {1}\u3000共 {2} 条
        emptyrecords: "No records to view",     //无数据显示
        loadtext: "Loading...",  //读取中
		savetext: "Saving...",
		pgtext: "Page {0} of {1}", //{0} 共 {1} 页
		pgfirst : "First Page",
		pglast : "Last Page",
		pgnext : "Next Page",
