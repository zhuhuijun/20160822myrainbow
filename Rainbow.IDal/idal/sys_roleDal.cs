...
{    
    ...
    /// sys_roleDal实现
    /// </summary>
    public partial interface Isys_roleDal    
    {    
	    /// <summary>
        /// 更新数据实体到上下文
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<sys_role> GetAll();
        /// <summary>
        /// 根据主键获得数据
        /// </summary>
        /// <param name="id">主键id</param>
        /// <returns></returns>
        sys_role GetById(string id);
        /// <summary>
        /// 删除数据
        /// </summary>
        ...
        /// <returns></returns>
        PageDataView<sys_role> GetPageData(PageCriteria criteria, object param = null);
        /// <summary>
        /// 匿名条件查询
        /// </summary>
        /// <param name="wherela"></param>
        /// <returns></returns>
        IEnumerable<sys_role> GetWhere(dynamic wherela);
        /// <summary>
        /// 按照条件获得数量
        /// </summary>
        /// <param name="wherela"></param>
