...
{    
    ...
    /// sys_actionDal实现
    /// </summary>
    public partial interface Isys_actionDal    
    {    
	    /// <summary>
        /// 更新数据实体到上下文
        /// </summary>
        ...
        /// <returns></returns>
        bool Insert(sys_action entity);
        /// <summary>
        /// 获得所有数据
        /// </summary>
        /// <returns></returns>
        IEnumerable<sys_action> GetAll();
        /// <summary>
        /// 根据主键获得数据
        /// </summary>
        /// <param name="id">主键id</param>
        /// <returns></returns>
        sys_action GetById(string id);
        /// <summary>
        /// 删除数据
        /// </summary>
        ...
        /// <returns></returns>
        PageDataView<sys_action> GetPageData(PageCriteria criteria, object param = null);
        /// <summary>
        /// 匿名条件查询
        /// </summary>
        /// <param name="wherela"></param>
        /// <returns></returns>
        IEnumerable<sys_action> GetWhere(dynamic wherela);
        /// <summary>
        /// 按照条件获得数量
        /// </summary>
        /// <param name="wherela"></param>
