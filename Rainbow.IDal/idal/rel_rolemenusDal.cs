...
{    
    ...
    {    
        ...
        /// <returns></returns>
        bool Insert(rel_rolemenus entity);
        /// <summary>
        /// 获得所有数据
        /// </summary>
        /// <returns></returns>
        IEnumerable<rel_rolemenus> GetAll();
        /// <summary>
        /// 根据主键获得数据
        /// </summary>
        /// <param name="id">主键id</param>
        /// <returns></returns>
        rel_rolemenus GetById(string id);
        /// <summary>
        /// 删除数据
        /// </summary>
        ...
        /// <returns></returns>
        PageDataView<rel_rolemenus> GetPageData(PageCriteria criteria, object param = null);
        /// <summary>
        /// 匿名条件查询
        /// </summary>
        /// <param name="wherela"></param>
        /// <returns></returns>
        IEnumerable<rel_rolemenus> GetWhere(dynamic wherela);
        /// <summary>
        /// 按照条件获得数量
        /// </summary>
        /// <param name="wherela"></param>
